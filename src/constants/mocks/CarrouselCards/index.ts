...
import { minicursoDesktop } from '../Aulas/MiniCursoDesenvolvimentoDesktop/index';
import { desvendandoDebugDelphi } from '../Aulas/MiniCursoDebugDelphi/index'
import { aulasApiRestHorse } from '../Aulas/ApiRestHorse';

export const optionsFirstCarrouselCard = [
  {
    id: 1,
    title: "Delphi e IntraWeb",
    data: [
      {
        id: 1,
      ...
      {
        id: 6,
        img: aulasMaratonaIntraWeb[5].img,
      ...
      {
        id: 7,
        img: aulasMaratonaIntraWeb[6].img,
      ...
      {
        id: 8,
        img: aulasMaratonaIntraWeb[7].img,
...
export const optionsSecondCarrouselCard = [
  {
    id: 1,
    title: "API´s com Horse ",
    data: [
      {
        id: 1,
        img: aulasApiRestHorse[0].img,
...
export const optionsThirdCarrouselCard = [
  {
    id: 1,
    title: "Desktop e Debug ",
    data: [
      {
        id: 1,
        img: minicursoDesktop[0].img,
      ...
      {
        id: 4,
        img: desvendandoDebugDelphi[0].img,
