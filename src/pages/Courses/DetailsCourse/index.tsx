...
const DetailsCourses = () => {
  ...
  return (
    <Containers.DefaultAnimated>
      <Helmet>
        <title>Cursos | {classSelected?.title? `${classSelected?.title}` : 'Cursos'}   |Universidade Delphi </title>
        <link
          rel="canonical"
          href={`https://www.universidadedelphi.com.br/cursos/${classSelected?.idCourse}/${classSelected?.id}`}
        />
      </Helmet>
      <Box
        sx={{
